...
/* Created on:     19/08/2010 11:51:40 a.m.                     */
/*==============================================================*/
...
/*==============================================================*/
/* Table: FABRICACIONES_DETALLES                                */
/*==============================================================*/
create table FABRICACIONES_DETALLES (
   ID_FABRICACION_DETALLE SERIAL               not null,
   ID_PROCESO_FABRICACION INT4                 not null,
   ID_DEPOSITO          INT4                 null,
   ID_PRODUCTO          INT4                 null,
   CANTIDAD             NUMERO               null default 1 
      constraint CKC_CANTIDAD_FABRICAC check (CANTIDAD is null or (CANTIDAD >= 1)),
   constraint PK_FABRICACIONES_DETALLES primary key (ID_FABRICACION_DETALLE)
);

/*==============================================================*/
/* Index: FABRICACIONES_DETALLES_PK                             */
/*==============================================================*/
create unique index FABRICACIONES_DETALLES_PK on FABRICACIONES_DETALLES (
ID_FABRICACION_DETALLE
);

/*==============================================================*/
/* Index: SE_FABRICAN_FK                                        */
/*==============================================================*/
create  index SE_FABRICAN_FK on FABRICACIONES_DETALLES (
ID_DEPOSITO,
ID_PRODUCTO
);
...
/* Index: FABRICA_FK                                            */
/*==============================================================*/
create  index FABRICA_FK on FABRICACIONES_DETALLES (
ID_PROCESO_FABRICACION
);
...
/*==============================================================*/
/* Table: PROCESOS_FABRICACION                                  */
/*==============================================================*/
create table PROCESOS_FABRICACION (
   ID_PROCESO_FABRICACION SERIAL               not null,
   ID_DEPOSITO          INT4                 null,
   ID_PRODUCTO          INT4                 null,
   FECHA_HORA           FECHA_HORA           null,
   constraint PK_PROCESOS_FABRICACION primary key (ID_PROCESO_FABRICACION)
);

/*==============================================================*/
/* Index: PROCESOS_FABRICACION_PK                               */
/*==============================================================*/
create unique index PROCESOS_FABRICACION_PK on PROCESOS_FABRICACION (
ID_PROCESO_FABRICACION
);
...
/* Index: TIENE_MP_FK                                           */
/*==============================================================*/
create  index TIENE_MP_FK on PROCESOS_FABRICACION (
ID_DEPOSITO,
ID_PRODUCTO
);
...
alter table FABRICACIONES_DETALLES
   add constraint FK_FABRICAC_FABRICA_PROCESOS foreign key (ID_PROCESO_FABRICACION)
      references PROCESOS_FABRICACION (ID_PROCESO_FABRICACION)
      on delete restrict on update restrict;

alter table FABRICACIONES_DETALLES
   add constraint FK_FABRICAC_SE_FABRIC_STOCKS foreign key (ID_DEPOSITO, ID_PRODUCTO)
      references STOCKS (ID_DEPOSITO, ID_PRODUCTO)
      on delete restrict on update restrict;

alter table PROCESOS_FABRICACION
   add constraint FK_PROCESOS_TIENE_MP_STOCKS foreign key (ID_DEPOSITO, ID_PRODUCTO)
      references STOCKS (ID_DEPOSITO, ID_PRODUCTO)
      on delete restrict on update restrict;
